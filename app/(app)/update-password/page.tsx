  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">Please enter your new secure password below.</p>
      </div>
          ...
          {sessionReady && (
            <>
              ...
              <form onSubmit={handleUpdate} className="space-y-5">
                ...
                >
                  {loading ? <span className="flex items-center gap-2"><Loader2 className="w-4 h-4 animate-spin" /> Updating…</span> : "Update Password"}
                </button>
              </form>
            </>
          )}
