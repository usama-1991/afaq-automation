  ...
  return (
    <div style={{ padding: '60px 32px', maxWidth: 800, margin: '0 auto', fontFamily: 'system-ui, sans-serif', color: '#111827', lineHeight: 1.6 }}>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p style={{ marginBottom: 12 }}>By accessing or using the Ittisalo platform, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.</p>
      </section>

      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontSize: 20, fontWeight: 800, marginBottom: 16 }}>2. Description of Service</h2>
        <p style={{ marginBottom: 12 }}>Ittisalo is a B2B Software-as-a-Service (SaaS) platform that provides AI-powered omnichannel messaging workflows, including integrations with the WhatsApp Business API. The service is provided "as is" and we reserve the right to modify or discontinue features at any time.</p>
      </section>

      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontSize: 20, fontWeight: 800, marginBottom: 16 }}>3. Meta & Third-Party API Policies</h2>
        <p style={{ marginBottom: 12 }}>By utilizing our WhatsApp integration, you strictly agree to comply with the <a href="https://www.whatsapp.com/legal/business-policy" target="_blank" rel="noopener noreferrer" style={{ color: '#0b63e5', textDecoration: 'none' }}>WhatsApp Business Policy</a> and <a href="https://www.whatsapp.com/legal/commerce-policy" target="_blank" rel="noopener noreferrer" style={{ color: '#0b63e5', textDecoration: 'none' }}>Commerce Policy</a>. Ittisalo is not responsible for any account suspension or bans imposed by Meta due to your violation of their messaging policies (e.g., sending unauthorized promotional broadcasts).</p>
      </section>

      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontSize: 20, fontWeight: 800, marginBottom: 16 }}>4. Account Security</h2>
        <p style={{ marginBottom: 12 }}>You are responsible for maintaining the confidentiality of your account credentials. You must immediately notify us of any unauthorized use of your account. Ittisalo will not be liable for any losses caused by unauthorized access to your workspace.</p>
      </section>

      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontSize: 20, fontWeight: 800, marginBottom: 16 }}>5. Payments, Subscriptions, and Trials</h2>
        <p style={{ marginBottom: 12 }}>Ittisalo may offer trial periods for its services. Upon expiration of a trial, you must subscribe to a paid tier to avoid service disruption. All payments are non-refundable unless legally required or explicitly stated otherwise.</p>
      </section>

      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontSize: 20, fontWeight: 800, marginBottom: 16 }}>6. Limitation of Liability</h2>
        <p style={{ marginBottom: 12 }}>To the maximum extent permitted by law, Ittisalo shall not be liable for any indirect, incidental, special, or consequential damages resulting from the use or inability to use our services, including but not limited to loss of profits, data, or business opportunities.</p>
      </section>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p style={{ marginBottom: 12 }}>For any questions regarding these terms, please contact us at <strong>legal@ittisalo.io</strong>.</p>
      </section>
