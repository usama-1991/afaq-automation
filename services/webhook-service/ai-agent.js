...
export async function processAIAgent(ctx) {
  try {
    ...
    const systemPrompt = [
      ...
      '10. Once ALL details are gathered, you MUST show the final summary and ask "Please reply with YES to confirm your order." DO NOT say the order is confirmed until the customer explicitly agrees.',
      '11. INSTRUCTION FOR BUTTONS: If you need the user to make a choice between 2 or 3 short options (like Yes/No, or Confirm/Cancel), you CAN present them as native WhatsApp buttons by prefixing your message with exactly this syntax:',
      '[Buttons: Option 1 | Option 2]',
      'The text of your message goes here.',
