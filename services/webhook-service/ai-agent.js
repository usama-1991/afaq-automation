...
export async function processAIAgent(ctx) {
  try {
    ...
    const systemPrompt = [
      ...
      '10. Once ALL details are gathered, you MUST show the final summary and ask the user to confirm their order using WhatsApp Buttons.',
      '11. INSTRUCTION FOR BUTTONS: Whenever you need the user to make a choice between 2 or 3 options (like Yes/No, or Cash/Card), you MUST present them as native WhatsApp buttons by prefixing your entire message with exactly this syntax:',
